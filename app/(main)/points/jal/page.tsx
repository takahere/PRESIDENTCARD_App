...
export default function JalExchangePage() {
      ...
      <div className="px-4 pt-4 pb-6 space-y-6">
          ...
          <div className="flex flex-col items-center gap-2 w-20">
            <div className="size-16 rounded-xl bg-white flex items-center justify-center">
              <svg viewBox="0 0 100 80" className="w-10 h-10">
                <circle cx="50" cy="35" r="24" fill="#E60012" />
                <text x="50" y="40" textAnchor="middle" fill="white" fontSize="14" fontWeight="bold">JAL</text>
                <text x="50" y="65" textAnchor="middle" fill="#E60012" fontSize="6">JAPAN AIRLINES</text>
              </svg>
            </div>
            <p className="text-[11px] font-semibold text-white text-center">JALマイル</p>
            <p className="text-[20px] font-semibold text-white font-sf-display tabular-nums">
              500,000,000
            </p>
          </div>
        ...
        <div className="bg-luxbrown-80 rounded-xl py-1">
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <span className="text-[13px] font-semibold text-white">＝ 500マイル</span>
          </div>
          <div className="flex items-center justify-between px-4 py-3">
